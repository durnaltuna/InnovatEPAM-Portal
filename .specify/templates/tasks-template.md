...
**Tests**: Tests are REQUIRED for every changed business-logic path. For documentation-only
or styling-only changes, tests MAY be omitted with explicit justification in tasks.md.
...
- [ ] T004 Add constitution compliance checklist for this feature (spec link, ADR link,
      test-first scope, reviewer accountability)
...
- [ ] T011 Create/update ADR when architecture, contracts, security boundaries, or
  deployment model are changed
...
- [ ] TXXX [P] Additional unit tests required to preserve coverage threshold in tests/unit/
